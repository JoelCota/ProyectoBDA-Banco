 ...
 * @author Joel Lopez
 */
public class GeneradorRetiroSinTarjeta extends javax.swing.JFrame {

    /**
     * Creates new form GeneradorRegistroSinTarjeta
     */
    public GeneradorRetiroSinTarjeta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Indique el retiro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeneradorRetiroSinTarjeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GeneradorRetiroSinTarjeta().setVisible(true);
            }
        });
    }
